                ...
                <nav className="navbar navbar-static-top" role="navigation" style={{ "margin-bottom": "0" }}>
                    ...
                    <ul className="nav navbar-top-links navbar-right">
                        ...
                        <li className="dropdown">
                            ...
                            <ul className="dropdown-menu dropdown-messages animated flipInX">
                                <li>
                                    <div className="dropdown-messages-box">
                                        <a href="profile.html" className="pull-left">
                                            <img alt="imagex" className="img-circle" src="img/a7.jpg" />
                                        </a>
                                ...
                                <li>
                                    <div className="dropdown-messages-box">
                                        <a href="profile.html" className="pull-left">
                                            <img alt="imagex" className="img-circle" src="img/a4.jpg" />
                                        </a>
                                        <div className="media-body ">
                                ...
                                <li>
                                    <div className="dropdown-messages-box">
                                        <a href="profile.html" className="pull-left">
                                            <img alt="imagex" className="img-circle" src="img/profile.jpg" />
                                        </a>
                                        <div className="media-body ">
